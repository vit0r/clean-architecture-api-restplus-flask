...
def test_bookitems_update_book_id_3_success(setup, book_id):
    ...
    response = test_client.put(__BASE_URL_ID.format(api_version, book_id), json=book_update)
...
def test_bookitems_patch_book_id_3_success(setup, book_id):
    ...
    response = test_client.patch(__BASE_URL_ID.format(api_version, book_id), json=book_patch)
