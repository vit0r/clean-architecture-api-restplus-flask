...
def valid_book_list():
    ...
    return [
        ...
        Book(
            ...
            synopsis=(
                "A Hobbit goes on an adventure and finds something that"
        ...
        Book(
            ...
            synopsis=(
                "A bitter Italian Diplomat makes a veiled attack on tyranny while explaining"
...
def invalid_id_book():
    ...
    return Book(
        ...
        number_of_pages=1,
        author=(
            "Someone who doesn't understand the importance of"
